...
const setupCheckoutForm = () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (pizzariaConfig.whatsapp) {
      ...
      // Exibe o modal de sucesso por 2 segundos antes de redirecionar
      showAlertModal(confirmationMessage, "Sucesso", true);
      setTimeout(() => {
        window.location.href = whatsappUrl; // Redireciona automaticamente para o WhatsApp
        closeAlertModal();
      }, 2000); // 2 segundos de delay para o usuário ler a mensagem
    } else {
      showAlertModal(
