...
.custom-pizza-btn:hover {
  transform: scale(1.1);
  background: #6b8e23;
}

#fixed-custom-pizza-btn {
  position: fixed;
  bottom: 20px;
  right: 20px;
  z-index: 100;
...
.cart-item .flavor-list {
  margin-top: 5px;
}

.cart-item .flavor-item {
  background: rgba(245, 245, 245, 0.2);
  padding: 4px 8px;
  border-radius: 5px;
  margin: 2px 0;
...
.cart-item .flavor-item:nth-child(1) .flavor-name {
  color: #ffd700;
}

.cart-item .flavor-item:nth-child(2) .flavor-name {
  color: #ff4500;
}

.cart-item .flavor-item:nth-child(3) .flavor-name {
  color: #6b8e23;
}

.cart-item .flavor-item:nth-child(4) .flavor-name {
  color: #f5f5f5;
}

.cart-item .flavor-item:nth-child(n + 5) .flavor-name {
  color: #d2b48c;
}
...
#pizza-svg path:hover {
  fill: #ff4500;
  stroke: #f5f5f5;
  stroke-width: 4;
}

#pizza-svg path.blinking {
...
.custom-pizza-content button:hover {
  transform: scale(1.05);
  background: #6b8e23;
}
...
.carousel-admin-item button:hover {
  transform: scale(1.1);
  background: #d2b48c;
}
...
#json-management button:hover {
  transform: scale(1.05);
  background: #ff6347;
}

#json-management label {
  color: #f5f5f5;
  font-size: 0.9rem;
}
